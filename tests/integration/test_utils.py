...
def test_load_vectorstore_existing(mock_faiss, mock_huggingface_embeddings):
    ...
    with patch("pathlib.Path.exists", return_value=True):
        ...
        vectorstore, metadata = load_vectorstore("test_path")
        ...
        # Verify the result is the FAISS instance
        assert vectorstore == mock_faiss_instance
        assert metadata is None  # No metadata mocked in this test
        ...
        vectorstore, metadata = load_vectorstore("test_path", custom_embedding)
...
def test_load_vectorstore_not_found():
    ...
    with patch("pathlib.Path.exists", return_value=False), \
        ...
        # Verify both vectorstore and metadata are None
